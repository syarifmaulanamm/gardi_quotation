...
{{ csrf_field() }}
    <div class="form-group">
        <label>Type</label>
        <input type="text" name="type" class="form-control" value="{{ $bedType->type }}" required>
    </div>
    <div class="form-group">
        <label>Capacity</label>
        <input type="number" min="1" max="10" name="capacity" class="form-control" value="{{ $bedType->capacity }}" required>
        <!-- <div class="row">
