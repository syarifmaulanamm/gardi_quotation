            ...
            <tbody>
                <tr>
                    <td class="text-center" colspan="7">
                        <a href="{{ url('quotation/'.$quotation->id.'/landarrangement/create?mode=manual') }}" class="btn btn-round btn-primary"><i class="ion-plus"></i> Add Item</a>
                    </td>
                </tr>
                @foreach($landArrangement as $item)
                <tr>
...
<script>
    $(document).ready(function(){
        ...
        $(".btn-delete").click(function(e){
            ...
            function(){
                $.ajax({
                    url: '{{ url('quotation/landarrangement') }}/'+id,
